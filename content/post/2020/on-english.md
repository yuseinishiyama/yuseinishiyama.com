...
ここでは、日本で大学を出た直後と現在の自分の英語理解を比較し、中級レベル以上の英語学習者に短期間で効果が出そうな事項をまとめてみた。
...
日本語の概念に無い第4文型（SVOO）と第5文型（SVOC）の動詞に弱い傾向がある。"Give a book to him"と"Give him a book"はどちらも正しい表現だが、日本語的な前者ばかりを使ってしまう人が多いのではないだろうか。頻出表現である"Do me a favor"や"Wish you luck"なども、意外とすんなり出てこないものだ。さらに、これに再帰代名詞が組み合わせれた以下のような会話表現ができるとこなれた印象を与えることができる。
...
ここでは「子供一般」を「6歳を過ぎた子供」に制限している。一方で、非制限用法はコンマを伴い、先行詞を補足するのみである。以下の例では、唯一である自分の妻について補足的な説明をしているのであり、複数人の"My wife"のうちの一人について述べている訳ではない。
...
自分で書ける必要はないが、固めの読み物・メールでは珍しくない。
...
学校教育で見落とされがちだが、中級から上級の話者に遷移するために重要と思われる項目を、我ながら上手くまとめられたのではないだろうか。時制・使役・as・仮定法・分詞構文なども扱う予定だったが、既にそこそこの分量になってしまったので、一旦ここまでとする。

ちなみに、冠詞・加算/不可算名詞・群動詞（give in「受け入れる」のような前置詞と前置の組み合わせ）はかなり奥が深く、基本中の基本を除いて、座学でマスターするのは難しいと思っている。これらは、無理せずに経験を通じて学習すればよいだろう。

最後に、ここでの内容の多くは自分が最も信頼を置いている文法書[『英文法解説』（著：江川泰一郎）](https://www.amazon.co.jp/dp/4760820094)を参考にしている。興味のある人はそちらも参照してみてほしい。
